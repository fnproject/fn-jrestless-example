...
public class FnRequestHandlerIntTest {
    ...
    // Note: There is a better version of this test in FnFutureRequestHandlerTest
    @Test
    public void testRoundTripBasic() throws JsonProcessingException {
        ...
        String contents = mapper.writeValueAsString(new FnRequestHandlerIntTest.AnObject("123"));
